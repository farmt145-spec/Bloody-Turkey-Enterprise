...
export default function FarmSelect() {
  ...
  const [form, setForm] = useState({ name: "", address: "", nip: "", contact: "", declaredHouses: 0, useDemoTemplate: false, withStarterData: truelse });
      ...
      <div className="w-full max-w-3xl">
        ...
        {formOpen && (
          ...
          >
            ...
            <label className="flex items-center gap-2 text-sm text-zinc-300">
              <input type="checkbox" checked={form.withStarterData}
                onChange={(e) => setForm({ ...form, withStarterData: e.target.checked })} />
              Dodaj przykładowe dane startowe (normy, receptury, 1 rzut demo)
            </label>
